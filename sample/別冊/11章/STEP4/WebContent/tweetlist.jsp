...
<body>
 <jsp:useBean id="TweetArrayBean" class="chapter11.tweet.TweetArrayBean" scope="session" />
 ...
 <table border="1">
  ...
  <%
    ArrayList<TweetBean> tweetArray = TweetArrayBean.getTweetArray();
      for (TweetBean record : tweetArray) {
  %>
  <tr>
   <td><a href="TweetPersonServlet?name=<%=URLEncoder.encode(record.getName(),"UTF-8")%>">
     <%=record.getName()%>
   </a></td>
